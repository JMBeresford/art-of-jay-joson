...
const Socials = (props) => {
  ...
  return (
    <div
      className={styles.socialsMenu + (dropped ? ` ${styles.open}` : '')
    ...
    >
      <div className={styles.wrapper} aria-hidden="true" onClick={() => setDropped(!dropped)}>
        ...
        <svg className={styles.arrow} xmlns="http://www.w3.org/2000/svg" width="7.266" height="14.533" viewBox="0 0 7.266 14.533">
          <path id="Icon_ionic-md-arrow-dropright" data-name="Icon ionic-md-arrow-dropright" d="M13.5,9l7.266,7.266L13.5,23.533Z" transform="translate(-13.5 -9)"/>
        </svg>
      </div>
